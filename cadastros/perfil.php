                    ...
                    <div class="address-container">
                        ...
                        <div class="form-group" style="flex: 50%;">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="text" id="cpf" name="cpf" value="<?php echo !empty($_SESSION['user_email']) ? htmlspecialchars($_SESSION['user_email']) : ''; ?>" class="form-control" oninput="formatCPF(this)">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-group" style="flex:20%;">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input
                                    ...
                                    name="nascimento"
                                    class="form-control"
                                    value="<?php echo !empty($_SESSION['user_access_level'])
                        ...
                        <div class="form-group" style="flex: 20%;">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input
                                    ...
                                    class="form-control"
                                    value="<?php
                                            if (!empty($_SESSION['criacao_user'])) {
                                                echo htmlspecialchars(
                                                    date('d/m/Y', strtotime($_SESSION['criacao_user']))
                                                );
                                            } else {
                                                echo '';
                                            }
                        ...
                        <div class="form-group" style="flex: 20%;">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input
                                    ...
                                    name="plano"
                                    class="form-control"
                                    value="<?php echo !empty($_SESSION['user_plan'])
                                                ? htmlspecialchars($_SESSION['user_plan'])
                                                : ''; ?>"
                                    readonly>
                            </div>
                        </div>
