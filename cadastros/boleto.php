...
<script>
    ...
    $(document).ready(function() {
            ...
            if (boleto.length > 0) {
                for (let index = 0; index < boleto.length; index++) {
                    ...
                    row.innerHTML = `
                        ...
                        <td>${recebe_boleto.valor}</td>
                        <td>
                            <div class="action-buttons">
                                <a href="#" class="view" title="Visualizar" id='visualizar-informacoes-plano' data-codigo-pessoa='${recebe_boleto.id}'>
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="?pg=grava_plano&acao=editar&id=${recebe_boleto.id}" target="_parent" class="edit" title="Editar">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="#" id='excluir-plano' data-codigo-pessoa="${recebe_boleto.id}" class="delete" title="Apagar">
        ...
        function inicializarDataTable() {
            recebe_tabela_planos = $("#boleto_tabela").DataTable({
                "language": {
