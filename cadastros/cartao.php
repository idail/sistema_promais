...
<div>
    <h1 class="dashboard">CARTÃO</h1>
</div>

<!-- Botão Cadastrar -->
<div>
    <button class="btn-cadastrar" onclick="window.location.href='?pg=grava_cartao&acao=cadastrar';">
    ...
    $(document).ready(function() {
        ...
        function preencher_tabela(pix) {
            ...
            if (pix.length > 0) {
                ...
                $("#cartao_tabela tbody").append("<tr><td colspan='9' style='text-align:center;'>Nenhum registro localizado</td></tr>");
            }
        }
