...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($recebe_processo_empresa === "inserir_empresa") {
        ...
        // Campos opcionais — se vazio ou não existir, atribui NULL
        $recebe_data_cadastro_empresa = !empty($_POST["valor_data_cadastro_empresa"]) ? $_POST["valor_data_cadastro_empresa"] : null;
