  ...
  <style>
    * {
    ...
    .form-group i {
      ...
      /* Certificando-se de que está centralizado verticalmente */
      color: #666;
      display: flex;
      align-items: center;
      height: 100%;
    ...
    .form-group input {
      ...
      /* Tamanho do campo */
      line-height: 45px;
      /* Alinha o texto no meio do campo */
    }
  ...
  <div class="login-container">
    ...
    <div class="login-image" style="background-image: url(&apos;./img/logos/fundo.png&apos;); background-size: cover; background-position: middle; background-repeat: no-repeat;">
      <div class="info-card">
        ...
        <p>
          Ao fazer login, você acessa um painel completo e personalizado, onde gerencia suas informações, acompanha seu perfil e aproveita ferramentas inteligentes que tornam sua rotina em Medicina e Segurança do Trabalho mais prática, rápida e segura.
        </p>
      </div>
    </div>
  </div>
